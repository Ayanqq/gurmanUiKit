        ...
        <nav className={s.footerNav}>
          ...
          <div className={s.navItem}>
            ...
            <div className={s.links}>
              <a href="#">
                <Typography size="16">Главная</Typography>
              </a>
              <a href="#">
                <Typography size="16">Партнеры</Typography>
              </a>
              <a href="#">
                <Typography size="16">Связаться</Typography>
              </a>
              <a href="#">
                <Typography size="16">Преимущества</Typography>
              </a>
              <a href="#">
                <Typography size="16">Контакты</Typography>
              </a>
            </div>
          </div>
        </nav>
